...
(function handleCompanyCode() {
    const input = document.getElementById('id_company_name'),
        ...
        domainMessage = document.getElementById('subdomainMessage')
    ...
    input.addEventListener('input', function (e) {
        ...
        if (e.srcElement.value && e.srcElement.value !== '') {
            domainMessage.classList.add('is-active')
        } else {
            domainMessage.classList.remove('is-active')
        }
    })
}())
...
function handleSubdomainChange() {
    ...
    if (companyNameField.style.display === 'none') {
