...
class Users(Base):
    ...
    def add_user(self, username, password, name=None, email=None, props=None):
        ...
        if props:
            ...
            for key, value in props.iteritems():
                payload["properties"]["property"].append(
                    {"@key": key, "@value": value}
                )
    ...
    def lock_user(self, username):
        ...
        """
        endpoint = "/".join(
            [self.endpoint.rpartition("/")[0], "lockouts", username]
        )
    ...
    def add_user_roster_item(
        self, username, jid, name=None, subscription=None, groups=None
    ):
        """
