...
STATICFILES_DIRS = [str(APPS_DIR / "static"), str(ROOT_DIR / "webapp/assets")]
...
ADMINS = [("""Víctor Villalobos""", "viktor@adslab.io")]
...
CHANNEL_LAYERS = {
    "default": {
        ...
        "CONFIG": {"hosts": [("redis", 6379)], "capacity": 1500, "expiry": 20},
    }
}
